          ...
          {invoices.map((inv) => (
            ...
            >
              ...
              <div className="flex items-start sm:items-center gap-3">
                <div className="w-9 h-9 rounded-xl bg-black/[0.05] dark:bg-white/[0.08] border border-black/5 dark:border-white/10 flex items-center justify-center text-zinc-800 dark:text-zinc-200 font-mono font-bold text-xs shrink-0">
